      ...
      <div class="row header">
        ...
        <div class="col-4 links">
          <q-icon
            ...
            size="40px"
            :name="links.linkedin"
            @click="goToUrl('https://www.linkedin.com/in/hasan-lookzadeh-0b0602232/')">
          ...
          <q-icon
            ...
            @click="goToUrl('https://www.instagram.com/_its.hasan_/')">
            <q-tooltip class="bg-orange text-body2" :offset="[10, 10]">
              Instagram
            </q-tooltip>
          </q-icon>
          <q-icon
            ...
            size="40px"
            :name="links.github"
            @click="goToUrl('https://github.com/MhasanLookzade')">
            <q-tooltip class="bg-orange text-body2" :offset="[10, 10]">
              Github
            </q-tooltip>
          </q-icon>
